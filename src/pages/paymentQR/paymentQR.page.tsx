	...
	return (
		<form className="flex flex-col mx-auto justify-center items-center p-5 max-w-md" onSubmit={handleSubmit}>
			...
			{loading ? <>
				...
				from-blue-600 to-red-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-red-800 font-medium rounded-2xl text-sm px-5 py-2.5 text-center me-2 mb-2`}>
